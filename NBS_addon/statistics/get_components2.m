function [comps, comp_sizes] = get_components2(adj,varargin)
...
%
%   Outputs:      comps,    vector of component assignments for each node (1 x #nodes)
%            comp_sizes,    vector of component sizes (1 x #components)
%
