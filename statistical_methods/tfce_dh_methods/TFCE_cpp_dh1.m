classdef TFCE_cpp_dh1
    ...
    properties (Constant)
        ...
        method_params = TFCE_cpp_dh1.get_tfce_params()
    end

    methods (Static, Access = private)
        function method_params = get_tfce_params()
            method_params = struct();
            method_params.dh = 0.01;
            method_params.H = 3.0;
            method_params.E = 0.4;
        end
    end
    ...
    methods
        ...
        function pval = run_method(obj,varargin)
            ...
            cluster_stats_target = traditional_tfce_cpp(test_stat_mat, obj.method_params.H, ...
                obj.method_params.E, obj.method_params.dh);
            ...
            for i = 1:K
                ...
                tfce_null = traditional_tfce_cpp(perm_stat_mat, obj.method_params.H, ...
                    obj.method_params.E, obj.method_params.dh);
